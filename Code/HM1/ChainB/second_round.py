...
def B1_response_based_update():
	df = pd.read_csv('truth_table.csv')
	# e: False, d: False, a: False
	for index, row in df[(df['d'] == False) & (df['a'] == False) & (df['e'] == False)].iterrows():
		add_sum = df[((df['d'] == True) | (df['a'] == True) | (df['e'] == True)) & ((df['l'] == row['l']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['f'] == row['f']) & (df['g'] == row['g']) & (df['h'] == row['h']) & (df['i'] == row['i']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Second_trust_based_updated'].sum()
		# print(add_sum)
...
def B2_response_based_update():
	df = pd.read_csv('truth_table.csv')
	# e: False, a: False
	for index, row in df[(df['a'] == False) & (df['e'] == False)].iterrows():
		add_sum = df[((df['a'] == True) | (df['e'] == True)) & ( (df['l'] == row['l']) & (df['d'] == row['d']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['f'] == row['f']) & (df['g'] == row['g']) & (df['h'] == row['h']) & (df['i'] == row['i']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Second_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Second_response_based_updated'] = row['Second_trust_based_updated'] + k * add_sum
...
def B1_calculation(row):
	df = pd.read_csv('truth_table.csv')

	ranking1 = df[(df['a'] == False) & (df['c'] == False) & (df['e'] == False)]['Second_response_based_updated'].sum()
	ranking2 = df[(df['a'] == True) & (df['c'] == True) & (df['e'] == False)]['Second_response_based_updated'].sum()
	ranking3 = df[(df['a'] == True) & (df['c'] == False) & (df['e'] == False)]['Second_response_based_updated'].sum()
	ranking4 = df[(df['a'] == False) & (df['c'] == True) & (df['e'] == False)]['Second_response_based_updated'].sum()

	human_ranking = [int(row['Ranking B-1_2']), int(row['Ranking B-1_3']), int(row['Ranking B-1_4']), int(row['Ranking B-1_5'])]
...
def B2_calculation(row):
	df = pd.read_csv('truth_table.csv')

	ranking1 = df[(df['d'] == True) & (df['e'] == True) & (df['l'] == True)]['Second_response_based_updated'].sum()
	ranking2 = df[(df['d'] == False) & (df['e'] == True) & (df['l'] == True)]['Second_response_based_updated'].sum()
	ranking3 = df[(df['d'] == False) & (df['e'] == False) & (df['l'] == False)]['Second_response_based_updated'].sum()
	ranking4 = df[(df['d'] == True) & (df['e'] == False) & (df['l'] == True)]['Second_response_based_updated'].sum()

	human_ranking = [int(row['Ranking B-2_1']), int(row['Ranking B-2_2']), int(row['Ranking B-2_3']), int(row['Ranking B-2_5'])]
...
def B3_calculation(row):
	...
	human_ranking = [int(row['Ranking B-3_2']), int(row['Ranking B-3_3']), int(row['Ranking B-3_4']), int(row['Ranking B-3_5'])]
...
def second_response_update(num):
	if num == 1:
		B1_response_based_update()
		# a, c, e: F, F, F/T, T, F/ T, F, F/F, T, F
	elif num == 2:
		B2_response_based_update()
		# d, e, l: T, T, T/F, T, T/F, F, F/T, F, T
	elif num == 3:
		B3_response_based_update()
