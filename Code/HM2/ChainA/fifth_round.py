...
def A1_1_1_trust_based_update(row, s, r):
	...
	for index, row in df[(df['h'] == True) | (df['j'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['d'] == row['d']) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['h'] == False) & (df['i'] == row['i']) & (df['j'] == False) & (df['k'] == row['k']))]['Fifth_trust_based_updated'].sum()
		# print(add_sum)
...
def A1_1_2_trust_based_update(row, s, r):
	...
	for index, row in df[(df['i'] == True) | (df['j'] == False)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['d'] == row['d']) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['h'] == row['h']) & (df['i'] == False) & (df['j'] == True) & (df['k'] == row['k']))]['Fifth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fifth_trust_based_updated'] = row['Fifth_trust_based_updated'] +  s * add_sum
...
def A1_2_1_trust_based_update(row, s, r):
	...
	for index, row in df[(df['i'] == True) | (df['g'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['d'] == row['d']) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['h'] == row['h']) & (df['i'] == False) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fifth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fifth_trust_based_updated'] = row['Fifth_trust_based_updated'] +  s * add_sum
...
def A1_2_2_trust_based_update(row, s, r):
	...
	for index, row in df[(df['i'] == True) | (df['d'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['d'] == False) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['h'] == row['h']) & (df['i'] == False) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fifth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fifth_trust_based_updated'] = row['Fifth_trust_based_updated'] +  s * add_sum
...
def A2_1_2_trust_based_update(row, s, r):
	...
	for index, row in df[(df['i'] == True) & (df['k'] == True)].iterrows():
		add_sum = df[((df['i'] == False) | (df['k'] == False)) & ((df['a'] == row['a'])&  (df['d'] == row['d']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['f'] == row['f']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['h'] == row['h']))]['Fourth_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fifth_trust_based_updated'] = row['Fourth_response_based_updated'] +  k * add_sum
...
def A2_2_3_trust_based_update(row, s, r):
	...
	for index, row in df[(df['i'] == False) | (df['a'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['d'] == row['d']) & (df['a'] == False)) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['h'] == row['h']) & (df['i'] == True) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fifth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fifth_trust_based_updated'] = row['Fifth_trust_based_updated'] +  s * add_sum
