...
def A1_1_trust_based_update(row, s, r):
	...
	for index, row in df[(df['h'] == True) & (df['i'] == True) & (df['f'] == True)].iterrows():
		add_sum = df[((df['h'] == False) | (df['i'] == False) | (df['f'] == False)) & ((df['a'] == row['a']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['d'] == row['d']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Third_response_based_updated'].sum()
		# print(add_sum)
...
def A1_2_trust_based_update(row, s, r):
	...
	for index, row in df[(df['h'] == True) & (df['g'] == True) & (df['d'] == True)].iterrows():
		add_sum = df[((df['h'] == False) | (df['g'] == False) | (df['d'] == False)) & ((df['a'] == row['a']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['i'] == row['i']) & (df['f'] == row['f']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Third_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Third_response_based_updated'] +  k * add_sum
...
def A1_3_trust_based_update(row, s, r):
	...
	for index, row in df[(df['h'] == True) & (df['g'] == True) & (df['a'] == True)].iterrows():
		add_sum = df[((df['h'] == False) | (df['g'] == False) | (df['a'] == False))&  ((df['d'] == row['d']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['i'] == row['i']) & (df['f'] == row['f']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Third_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Third_response_based_updated'] +  k * add_sum
...
def A2_1_trust_based_update(row, s, r):
	...
	for index, row in df[(df['h'] == True) & (df['g'] == True) & (df['i'] == True)].iterrows():
		add_sum = df[((df['h'] == False) | (df['g'] == False) | (df['i'] == False)) & ((df['d'] == row['d']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['a'] == row['a']) & (df['f'] == row['f']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Third_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Third_response_based_updated'] +  k * add_sum
...
def A2_2_trust_based_update(row, s, r):
	...
	for index, row in df[(df['h'] == True) & (df['g'] == False) & (df['a'] == True)].iterrows():
		add_sum = df[((df['h'] == False) | (df['g'] == True) | (df['a'] == False)) & ((df['d'] == row['d']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['i'] == row['i']) & (df['f'] == row['f']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Third_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Third_response_based_updated'] +  k * add_sum
...
def A1_1_1_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['f'] == True) | (df['j'] == True) | (df['h'] == True)].iterrows():
		add_sum = df[((df['f'] == False) & (df['e'] == False) & (df['d'] == row['d']) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['h'] == False) & (df['i'] == row['i']) & (df['j'] == False) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
...
def A1_1_1_response_based_update():
	...
	for index, row in df[(df['j'] == False) & (df['h'] == False)].iterrows():
		add_sum = df[((df['j'] == True) | (df['h'] == True)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['d'] == row['d']) & (df['e'] == row['e']) & (df['g'] == row['g']) & (df['i'] == row['i']) & (df['a'] == row['a']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
...
def A1_1_2_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['f'] == True) | (df['j'] == False) | (df['i'] == True)].iterrows():
		add_sum = df[((df['f'] == False) & (df['e'] == False) & (df['d'] == row['d']) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == False) & (df['h'] == row['h']) & (df['j'] == True) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A1_1_2_response_based_update():
	...
	for index, row in df[(df['j'] == True) & (df['i'] == False)].iterrows():
		add_sum = df[((df['j'] == False) | (df['i'] == True)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['d'] == row['d']) & (df['e'] == row['e']) & (df['g'] == row['g']) & (df['h'] == row['h']) & (df['a'] == row['a']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
...
def A1_2_1_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['d'] == True) | (df['i'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['d'] == False) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == False) & (df['h'] == row['h']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A1_2_1_response_based_update():
	...
	for index, row in df[(df['g'] == False) & (df['i'] == False)].iterrows():
		add_sum = df[((df['g'] == True) | (df['i'] == True)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['d'] == row['d']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['h'] == row['h']) & (df['a'] == row['a']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
	...
	for index, row in df[(df['h'] == False) |(df['g'] == False) | (df['d'] == False) | (df['j'] == False) ].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] ==row['e']) & (df['d'] == True) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == True) & (df['h'] == True) & (df['i'] == row['i']) & (df['j'] == True) & (df['k'] == row['k']))]['Fourth_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_response_based_updated'] +  s * add_sum
...
def A1_2_2_response_based_update():
	...
	for index, row in df[(df['d'] == False) & (df['i'] == False)].iterrows():
		add_sum = df[((df['d'] == True) | (df['i'] == True)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['h'] == row['h']) & (df['a'] == row['a']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
	...
	for index, row in df[(df['h'] == False) |(df['g'] == False) | (df['d'] == False) | (df['j'] == False) | (df['i'] == False) ].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] ==row['e']) & (df['d'] == True) & (df['a'] == row['a'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == True) & (df['h'] == True) & (df['i'] == False) & (df['j'] == True) & (df['k'] == row['k']))]['Fourth_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_response_based_updated'] +  s * add_sum
...
def A1_3_1_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['a'] == True) | (df['i'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['a'] == False) & (df['d'] == row['d'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == False) & (df['h'] == row['h']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A1_3_1_response_based_update():
	...
	for index, row in df[(df['a'] == False) & (df['i'] == False)].iterrows():
		add_sum = df[((df['a'] == True) | (df['i'] == True)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['h'] == row['h']) & (df['d'] == row['d']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
	...
	for index, row in df[(df['h'] == False) |(df['g'] == False) | (df['a'] == False)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] ==row['e']) & (df['d'] == row['d']) & (df['a'] == True)) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == True) & (df['h'] == True) & (df['i'] == row['i']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_response_based_updated'] +  s * add_sum
...
def A2_1_1_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['a'] == True) | (df['j'] == True)| (df['h'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['a'] == False) & (df['d'] == row['d'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == row['i']) & (df['h'] == False) & (df['j'] == False) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A2_1_2_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['a'] == True) | (df['j'] == False)| (df['i'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['a'] == False) & (df['d'] == row['d'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == False) & (df['h'] == row['h']) & (df['j'] == True) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A2_2_1_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['a'] == True) | (df['i'] == True)| (df['h'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['a'] == False) & (df['d'] == row['d'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == False) & (df['h'] == False) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A2_2_1_response_based_update():
	...
	for index, row in df[(df['h'] == False) & (df['i'] == False)].iterrows():
		add_sum = df[((df['h'] == True) | (df['i'] == True)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['d'] == row['d']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['g'] == row['g']) & (df['a'] == row['a']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
	...
	for index, row in df[(df['h'] == False) |(df['g'] == True) | (df['a'] == False)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] ==row['e']) & (df['d'] == row['d']) & (df['a'] == True)) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['h'] == True) & (df['i'] == row['i']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_response_based_updated'] +  s * add_sum
...
def A2_2_2_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['a'] == True) | (df['i'] == False)| (df['h'] == True)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['a'] == False) & (df['d'] == row['d'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == True) & (df['h'] == False) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A2_2_2_response_based_update():
	...
	for index, row in df[(df['h'] == False) & (df['i'] == True)].iterrows():
		add_sum = df[((df['h'] == True) | (df['i'] == False)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['d'] == row['d']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['g'] == row['g']) & (df['a'] == row['a']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
...
def A2_2_3_trust_based_update():
	df = pd.read_csv('truth_table.csv')

	for index, row in df[(df['g'] == True) |(df['a'] == True) | (df['i'] == False)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] == row['e']) & (df['a'] == False) & (df['d'] == row['d'])) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['i'] == True) & (df['h'] == row['h']) & (df['j'] == row['j']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_trust_based_updated'] = row['Fourth_trust_based_updated'] +  s * add_sum
...
def A2_2_3_response_based_update():
	...
	for index, row in df[(df['a'] == False) & (df['i'] == True)].iterrows():
		add_sum = df[((df['a'] == True) | (df['i'] == False)) & ((df['f'] == row['f']) & (df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == row['g']) & (df['e'] == row['e']) & (df['j'] == row['j']) & (df['h'] == row['h']) & (df['d'] == row['d']) & (df['k'] == row['k']))]['Fourth_trust_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_trust_based_updated'] + k * add_sum
	...
	for index, row in df[(df['h'] == False) |(df['g'] == True) | (df['a'] == False) | (df['j'] == False)].iterrows():
		add_sum = df[((df['f'] == row['f']) & (df['e'] ==row['e']) & (df['d'] == row['d']) & (df['a'] == True)) & ((df['b'] == row['b']) & (df['c'] == row['c']) & (df['g'] == False) & (df['h'] == True) & (df['i'] == row['i']) & (df['j'] == True) & (df['k'] == row['k']))]['Fourth_response_based_updated'].sum()
		# print(add_sum)
		df.at[index, 'Fourth_response_based_updated'] = row['Fourth_response_based_updated'] +  s * add_sum
